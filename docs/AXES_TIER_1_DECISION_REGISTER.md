...
| P2 | Connect AXES Contracting domain and complete email migration | Pending | Founder-approved access inventory, rollback plan, exact provider records, and post-change verification | Requires authorized Railway, DNS, and mail-provider action; do not change settings from this repository |
