...
| --- | --- | --- | --- |
| A1 | Legal business entity (LLC/Corp) for AXES Contracting | **RESOLVED 2026-09-19 — confirmed via official CSLB source.** "Axes Contracting Inc" is an active CA General Corporation, filed 2013, entity #3544685, with the founder (Axel Urartu) as sole officer/registered agent. Its CSLB contractor license (#995577) is confirmed **active** directly at the official CSLB site (expires 08/31/2028) — the earlier "suspended" reading was stale third-party aggregator data, not the real status. See `AXES_CONTRACTING_INC_ENTITY_VERIFICATION.md` for full sourcing and the correction record. | No new formation needed, and no bond renewal needed. Entity and license are both confirmed real and active; can proceed to IP-assignment (A2) and trademark/copyright (A3-A4) using this entity. |
