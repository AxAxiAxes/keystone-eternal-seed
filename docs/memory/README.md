...
- [2026-09-25 Local daily reconciliation draft automation foundation (repository-only, zero-provider-cost script + deterministic tests + operator manual promotion path)](2026-09-25-local-daily-diary-automation-foundation.md)
